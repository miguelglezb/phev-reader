...
def phys_quants_units_default(key):
    ...
    distance_default_quants_units = ["distance", "ph. distance units", distance_dict["ph. distance units"]]
    velocity_default_quants_units = ["velocity", "ph. velocity units", velocity_dict["ph. velocity units"]]
    density_default_quants_units = ["density", "ph. density units", density_dict["ph. density units"]]
    energy_default_quants_units = ["energy", "ph. energy units", energy_dict["ph. energy units"]]
    momentum_default_quants_units = ["momentum", "ph. momentum units", momentum_dict["ph. momentum units"]]
    angmom_default_quants_units = ["angular momentum", "ph. angular momentum units", 
    ...
    if key in quant_dict.keys(): 
        return quant_dict[key]
    else: 
        return ["Null", "Unknown quantity", 1.]
